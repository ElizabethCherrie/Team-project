...
export const rolePageMeta = {
  ADMINISTRATOR: {
    pageTitle: "IPOS-SA Admin",
    heroTitle: "Administrator",
    heroLead: "Administrative dashboard for merchant setup, catalogue control, and user access management.",
    actionsEyebrow: "Admin",
    actionsTitle: "Admin Actions",
  },
  MANAGER: {
    pageTitle: "IPOS-SA Manager",
    heroTitle: "Manager",
    heroLead: "Manager workspace for reports, merchant account decisions, and non-commercial application handling.",
    actionsEyebrow: "Manager",
    actionsTitle: "Manager Actions",
  },
  OPERATIONS_STAFF: {
    pageTitle: "IPOS-SA Operations",
    heroTitle: "Operations Staff",
    heroLead: "Operations control for dispatch details, order status updates, invoice generation, and order tracking.",
    actionsEyebrow: "Operations",
    actionsTitle: "Operations Actions",
  },
  ACCOUNTING_STAFF: {
    pageTitle: "IPOS-SA Accounting",
    heroTitle: "Accounting Staff",
    heroLead: "Accounting workspace for recording payments, checking balances, and monitoring overdue accounts.",
    actionsEyebrow: "Accounting",
    actionsTitle: "Accounting Actions",
  },
  MERCHANT: {
    pageTitle: "IPOS-SA Merchant",
    heroTitle: "Merchant Portal",
    heroLead: "Merchant portal for catalogue access, ordering, invoice viewing, reminders, and account balance checks.",
    actionsEyebrow: "Merchant",
    actionsTitle: "Merchant Actions",
  },
  ALL: {
    pageTitle: "IPOS-SA Dashboard",
    heroTitle: "IPOS-SA Dashboard",
    heroLead: "Role-based operational dashboard for the Server Application. Use the panels below to exercise the backend implementation and present the required demo flows.",
    actionsEyebrow: "Actions",
    actionsTitle: "Role Dashboard",
  },
};
...
export const actionDescriptions = {
  ...
  sweepAccounts: "Run account status sweep now — applies SUSPENDED/IN_DEFAULT rules to all merchants.",
  ...
  ["email", "Email", "demo_user@example.com"],
    ...
    },
    {
      ...
      buttons: [
        ...
        ["Trigger Account Status Sweep", "sweepAccounts"],
      ],
    },
    {
      pill: "Admin",
